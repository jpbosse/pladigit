...
<head>
    ...
    <title>419 — Session expirée · Pladigit</title>
    <style>
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .code { font-size: 72px; font-weight: 800; color: #C9A84C; line-height: 1; }
...
<body>
    <div class="card">
        ...
        <p>Votre session a expiré pour des raisons de sécurité. Veuillez recharger la page et réessayer.</p>
        <a href="{{ url()->previous('/') }}">← Recharger la page</a>
    </div>
</body>
</html>
