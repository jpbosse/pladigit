...
@php
    ...
    $saNav = [
        ...
        [
            'label' => 'Mises à jour',
            'icon'  => '<svg style="width:15px;height:15px;flex-shrink:0;fill:none;stroke:currentColor;stroke-width:1.8;stroke-linecap:round;" viewBox="0 0 24 24"><polyline points="23 4 23 10 17 10"/><polyline points="1 20 1 14 7 14"/><path d="M3.51 9a9 9 0 0 1 14.85-3.36L23 10M1 14l4.64 4.36A9 9 0 0 0 20.49 15"/></svg>',
            'route' => 'super-admin.update',
            'match' => 'super-admin.update*',
        ],
        [
            'label' => 'Sécurité',
...
<footer style="height:44px;background:var(--pd-surface);
    ...
    <div style="display:flex;align-items:center;gap:14px;">
        <span style="background:var(--pd-bg);border:1px solid var(--pd-border);
            ...
            v{{ config('app.version') }} · Super Admin
        </span>
