...
try {
    ...
    \$dbName = \$cfg['db']['name'] ?? 'pladigit';
    \$dbUser = \$cfg['db']['app_user'] ?? 'pladigit';
    \$successHtml = '<!DOCTYPE html><html lang="fr"><head><meta charset="UTF-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>Pladigit installe</title>'
        ...
        . '<div class="row"><span class="lbl">URL</span><span>' . \$url . '/super-admin</span></div>'
        . '<div class="row"><span class="lbl">Email</span><span><code>' . \$email . '</code></span></div>'
        ...
        . '<div class="row"><span class="lbl">Base</span><span><code>' . \$dbName . '</code></span></div>'
        . '<div class="row"><span class="lbl">Utilisateur</span><span><code>' . \$dbUser . '</code></span></div>'
        . '</div>'
